    ...
    <body class="font-sans antialiased bg-[#f4f6f8] text-slate-900">
        <div class="min-h-screen flex flex-col sm:justify-center items-center p-6 relative">
            ...
            <div class="mt-12 relative z-10">
                <a href="/" class="text-xs font-bold text-black hover:bg-slate-50 transition-all flex items-center bg-transparent px-5 py-3 rounded-full border-2 border-black hover:shadow-md uppercase tracking-widest">
