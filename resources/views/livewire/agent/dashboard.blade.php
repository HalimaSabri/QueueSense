    ...
    <div class="max-w-[85rem] mx-auto px-6 lg:px-8 space-y-10">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div class="lg:col-span-8 flex flex-col">
                ...
                @if($activeTicket)
                <!-- Active Session Card - Dark Theme Inspired by Image -->
                <div class="bg-[#1c1c1e] rounded-[2.5rem] p-12 flex flex-col items-center justify-center relative overflow-hidden shadow-2xl shadow-black/10 min-h-[500px] w-full">
                    <div class="text-center z-10 w-full max-w-md">
                        ...
                        <button wire:click="completeService" class="group w-full py-5 px-8 bg-white text-[#1c1c1e] text-sm font-bold rounded-2xl hover:bg-gray-100 transition-all flex items-center justify-center mx-auto shadow-lg">
                            Complete Session
                ...
                <div class="bg-white rounded-[2.5rem] p-12 flex flex-col items-center justify-center relative overflow-hidden shadow-sm border border-gray-200/60 min-h-[500px] w-full">
                    <div class="text-center max-w-md z-10 w-full">
                        ...
                        <!-- Well Defined Button Inspired by Image -->
                        <button wire:click="callNext" @if($queueCount === 0) disabled @endif class="w-full py-5 px-8 bg-[#1c1c1e] text-white text-sm font-bold rounded-2xl hover:bg-black transition-all disabled:opacity-30 disabled:cursor-not-allowed shadow-xl shadow-black/10">
                            Pull Next Client
                        </button>
                    </div>
                </div>
            ...
            <div class="lg:col-span-4 flex flex-col">
                <div class="bg-white rounded-[2.5rem] shadow-sm border border-gray-200/60 p-8 flex flex-col h-[500px]">
                    ...
                    <div class="flex-1 overflow-y-auto space-y-2 pr-3 custom-scrollbar">
                        @forelse($queues as $q)
                            <!-- List Item Inspired by 'Last Transaction' in Image -->
                    ...
                    <!-- Optional View All Button like the image has at bottom of list -->
                    @if(count($queues) > 0)
                    <div class="mt-6 pt-4 border-t border-gray-100">
                        <button class="w-full py-3.5 bg-[#f4f6f8] text-slate-800 text-sm font-bold rounded-xl hover:bg-gray-200 transition-colors">
                            View All History
                        </button>
                    </div>
                    @endif
