            ...
            <div class="lg:col-span-8 flex flex-col">
                ...
                <div class="bg-[#e2e8f0] rounded-[2.5rem] p-12 flex flex-col items-center justify-center relative overflow-hidden shadow-sm border border-slate-300/50 min-h-[500px] w-full">
                    <div class="text-center z-10 w-full max-w-md">
                        ...
                        <button wire:click="completeService" class="group w-full py-5 px-8 bg-white text-slate-900 text-sm font-bold rounded-2xl hover:bg-slate-50 transition-all flex items-center justify-center mx-auto shadow-sm">
                            Complete Session
