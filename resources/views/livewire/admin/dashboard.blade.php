    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-10">
        ...
        <div class="flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div>
                ...
                <p class="mt-2 text-slate-600 font-medium">Real-time insights and performance metrics for QueueSense.</p>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="bg-white rounded-[2rem] p-10 shadow-xl shadow-slate-200/50 border border-slate-200/60 relative overflow-hidden group hover:scale-[1.02] transition-transform duration-500">
                ...
                <h3 class="text-slate-600 text-xs font-black uppercase tracking-widest mb-1">Served Today</h3>
            ...
            <div class="bg-white rounded-[2rem] p-10 shadow-xl shadow-slate-200/50 border border-slate-200/60 relative overflow-hidden group hover:scale-[1.02] transition-transform duration-500">
                ...
                <h3 class="text-slate-600 text-xs font-black uppercase tracking-widest mb-1">Avg Wait Time</h3>
                <div class="flex items-baseline gap-2">
                    <p class="text-5xl font-black text-slate-900 tracking-tight">{{ $avgWaitTime }}</p>
                    <span class="text-slate-600 font-bold text-lg">mins</span>
                </div>
            ...
            <div class="bg-white rounded-[2rem] p-10 shadow-xl shadow-slate-200/50 border border-slate-200/60 relative overflow-hidden group hover:scale-[1.02] transition-transform duration-500">
                ...
                <h3 class="text-slate-600 text-xs font-black uppercase tracking-widest mb-1">Avg Service</h3>
                <div class="flex items-baseline gap-2">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
            <div class="bg-white rounded-[2.5rem] p-10 shadow-xl shadow-slate-200/50 border border-slate-200/60 h-[450px] flex flex-col">
                <div class="flex items-center justify-between mb-10">
                    ...
                    <select class="bg-slate-50 border-none rounded-xl text-xs font-bold text-slate-600 focus:ring-0 cursor-pointer">
            ...
            <div class="bg-white rounded-[2.5rem] p-10 shadow-xl shadow-slate-200/50 border border-slate-200/60 h-[450px] flex flex-col">
                <div class="flex items-center justify-between mb-10">
                    ...
                    <div class="flex gap-2">
                        ...
                        <span class="text-[10px] font-black uppercase text-slate-600 tracking-widest">Wait Time</span>
                    </div>
                </div>
                <div class="flex-1 min-h-0">
