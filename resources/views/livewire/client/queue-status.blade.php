<div class="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-6 text-slate-900 font-sans" wire:poll.5s>
    <div class="max-w-xl w-full">
        <div class="bg-white border border-slate-200 p-12 md:p-16 rounded-[2.5rem] text-center shadow-xl relative overflow-hidden">
            ...
            <div class="mb-12">
                <span class="text-slate-600 text-[10px] font-bold uppercase tracking-widest mb-4 block">Ticket Identity</span>
            ...
            <div class="grid grid-cols-2 gap-6 mb-12">
                ...
                <div class="p-8 bg-slate-50 rounded-3xl border border-slate-100">
                    ...
                    <span class="text-[10px] text-slate-600 uppercase tracking-wider font-bold">Est. Wait</span>
                </div>
            </div>
            ...
            <div class="bg-slate-50 rounded-3xl p-8 border border-slate-100 mb-10">
                ...
                <div class="flex items-center justify-between">
                    <span class="text-slate-600 text-[10px] font-bold uppercase tracking-wider">Protocol Status</span>
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-8 pt-4">
                <a href="{{ route('home') }}" wire:navigate class="text-[10px] font-bold text-slate-600 hover:text-indigo-600 uppercase tracking-widest transition-colors flex items-center">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path></svg>
                    New Request
                </a>
                <button onclick="window.print()" class="text-[10px] font-bold text-slate-600 hover:text-slate-900 uppercase tracking-widest transition-colors flex items-center">
