<div class="min-h-screen bg-[#f4f6f8] flex flex-col items-center justify-center p-6 text-slate-900 font-sans">
    ...
    <div class="absolute top-8 right-8 z-20">
        <a href="{{ route('login') }}" class="group px-6 py-3 bg-white border border-gray-200/60 rounded-2xl text-slate-800 hover:bg-slate-50 transition-all text-xs font-bold flex items-center shadow-sm">
            Staff Portal
        </a>
    </div>
